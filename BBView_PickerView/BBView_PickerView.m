...
#import "BBView_PickerView.h"
//#import "CustomAlertView.h"

@interface BBView_PickerView ()<
...
@implementation BBView_PickerView
...
- (NSString *)pickerView:(UIPickerView *)pickerView titleForRow:(NSInteger)row forComponent:(NSInteger)component {
    ...
    switch (component) {
        ...
        {
            if (isCustomDatePicker) {
                return [NSString stringWithFormat:@"%.2ld",row+1];
            }
            if (curComponents == 1) {
...
//                        return;
            ...
            NSString *str_temp = [NSString stringWithFormat:@"%ld-%.2ld-%.2ld~%@-%.2ld-%.2ld",(long)curYear,(long)firSeleMonth,(long)firSeleDay,curDefaultYear,secSeleMonth,secSeleDay];
